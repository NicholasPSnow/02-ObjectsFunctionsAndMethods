...
def main():
    ...
    even_better_draw_circles(rg.Point(0, 0), 15, 10, 'red', 5)
    even_better_draw_circles(rg.Point( 50,  50),15,10,'blue',2)
    even_better_draw_circles(rg.Point(-50, -50), 15, 10, 'blue', 2)
    even_better_draw_circles(rg.Point(-50, 50), 15, 10, 'green', 2)
    even_better_draw_circles(rg.Point(50, -50), 15, 10, 'green', 2)
    window.update()
