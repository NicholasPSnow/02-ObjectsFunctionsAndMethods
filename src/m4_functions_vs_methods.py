...
def try_methods():
    ...
    turtwig.pen=rg.Pen('brown',5)
    turtwig.forward(150)
    turtwig.left(90)
    turtwig.forward(50)
    turtwig.backward(100)
...
def try_methods_and_functions():
    ...
    bulbasaur.speed=1
    draw_many_squares(bulbasaur,2,100,30)
    bulbasaur.speed = 5
    bulbasaur.pen.color = 'red'
    draw_many_squares(bulbasaur,10, 50, 15)
    bulbasaur.speed = 100
    bulbasaur.pen.thickness = 35
    draw_many_squares(bulbasaur,8, 300, 60)
    bulbasaur.pen = rg.Pen('black', 3)
    bulbasaur.backward(200)
    bulbasaur.draw_circle(30)
    bulbasaur.draw_square(50)
