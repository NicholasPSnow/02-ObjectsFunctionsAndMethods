...
def main():
    print("hypotenuse=", Pythagorean(3, 4))
    turtlemaker('red', 15)
    turtlemaker('black', 25)
    """
...
#
###############################################################################
def turtlemaker (color, pensize):
    window = rg.TurtleWindow()
    greenturtle = rg.SimpleTurtle()
    thickturtle = rg.SimpleTurtle()
    greenturtle.pen = rg.Pen('green', pensize)
    thickturtle.pen = rg.Pen(color, 5)
    greenturtle.forward(100)
    thickturtle.backward(100)
